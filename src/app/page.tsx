...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* フォーム */}
      <div className="flex-1 max-w-lg mx-auto w-full px-5 py-5 map-texture-bg">
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-sm border border-stone-200/60 p-5 space-y-5">
          {/* どんな暮らしがしたい？ */}
          <VibePicker
